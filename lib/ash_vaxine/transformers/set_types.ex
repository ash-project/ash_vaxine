defmodule AshVaxine.Transformers.SetTypes do
  ...
  defp get_type(:string) do
    AshVaxine.Types.String
  end

  defp get_type(:uuid) do
    AshVaxine.Types.String
  end
  ...
  defp set_calculation_types(dsl_state) do
    ...
    |> Enum.reduce_while({:ok, dsl_state}, fn calculation, {:ok, dsl_state} ->
      type = get_type(calculation.type)
